...
- `REPO-DDB-001`: The repository shall define one canonical composite-document base contract for overview whiteboards, overview analyses, functional sets, legacy product overviews retained for compatibility, product decompositions, and implementation plans.
