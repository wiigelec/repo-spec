...
- `REPO-IPL-001`: An implementation plan shall be stored under `repo/docs/plans/` and shall use the canonical top-level `*-IMPLEMENTATION-PLAN.md` controlling document plus subordinate chunks.
