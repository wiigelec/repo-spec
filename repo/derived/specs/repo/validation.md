...
- `REPO-VAL-019`: Each leaf validation entry point shall enforce, for governed development-document roots within its owned tree, the canonical roots, top-level controlling-document filename patterns, subordinate chunk-directory naming, chunk inventory correspondence, and contiguous chunk numbering.
