...
- `REPO-PP-012`: Files not listed in the managed profile artifact inventory shall be treated as unmanaged by this contract, shall retain their existing ownership or bootstrap handling, and shall not be migrated, regenerated, or reclassified by this issue.
...
- artifact: `repo/scripts/github_field_policy_mutation_test.py`
