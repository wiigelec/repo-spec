...
- `REPO-PP-003`: The repository shall reserve `repo/profiles/github/` for future reusable GitHub profile source material and `.github/` for current installed GitHub adapters.
