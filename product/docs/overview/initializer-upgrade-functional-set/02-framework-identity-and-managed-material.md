...
That directional responsibility includes reasoning about material that is unchanged, changed, introduced, retired, or retargeted, plus the dependencies necessary for a coherent upgrade set.
