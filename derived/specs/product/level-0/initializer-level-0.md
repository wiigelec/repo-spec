...
Generated by `scripts/generate-docs` from `specs/product/level-0/initializer-level-0.json`.
...
`specs/product/level-0/initializer-level-0.json`
...
- `markdown`: `derived/specs/product/level-0/initializer-level-0.md`
