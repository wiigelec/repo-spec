...
Generated by `scripts/generate-docs` from `specs/repo/development-document-base.json`.
...
`specs/repo/development-document-base.json`
...
- `markdown`: `derived/specs/repo/development-document-base.md`
