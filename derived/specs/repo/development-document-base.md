...
- `REPO-DDB-004`: The top-level controlling document shall declare the artifact identifier, artifact type, product scope, authority category, lifecycle status, governing issue, predecessor or controlling sources, subordinate chunk inventory, successor action, and contract version in a machine-readable envelope.
