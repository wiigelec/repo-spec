...
- `REPO-VAL-007`: The validation entry point shall enforce allowed dependency directions, acyclic dependencies, and allow dependency targets only from candidate or accepted specifications.
