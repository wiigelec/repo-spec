...
def declared_repo_fixture_paths(repo_root: Path) -> tuple[str, ...]:
    ...
    required_paths = [
        ...
        "schemas/repo/development-document-base.schema.json",
        "schemas/repo/product-overview.schema.json",
        "schemas/repo/product-decomposition.schema.json",
        "schemas/repo/implementation-plan.schema.json",
