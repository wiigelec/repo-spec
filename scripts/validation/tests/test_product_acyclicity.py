...
def configure_spec(temp_repo: Path, dest_path: str, *, spec_id: str, title: str, purpose: str, dependency_ids: list[str]) -> None:
    mutate_json(
        ...
        lambda spec: (
            ...
            spec.__setitem__("derived_artifacts", [{"type": "markdown", "path": f"derived/specs/product/{Path(dest_path).stem}.md"}]),
            spec,
        )[-1],
    )
...
def run_product_acyclicity_tests(repo_root: Path) -> None:
    with tempfile.TemporaryDirectory(prefix="repo-spec-validation-") as temp_root_name:
        ...
        install_fixture(temp_repo, "manifest-valid-four.json", "specs/product/manifest.json")
        install_fixture(temp_repo, "level-0-candidate-status-accepted.json", "specs/product/level-0/kernel.json")
        install_fixture(temp_repo, "level-0-candidate-status-accepted.json", "specs/product/level-0/a.json")
        install_fixture(temp_repo, "level-0-candidate-status-accepted.json", "specs/product/level-0/b.json")
        install_fixture(temp_repo, "level-1-accepted.json", "specs/product/level-1/primitive.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/component.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/orchestration.json")
        configure_spec(temp_repo, "specs/product/level-0/a.json", spec_id="product.a", title="A", purpose="A product specification.", dependency_ids=["product.b"])
        configure_spec(temp_repo, "specs/product/level-0/b.json", spec_id="product.b", title="B", purpose="B product specification.", dependency_ids=["product.a"])
        write_manifest(
            temp_repo,
            [
                {"spec_id": "product.kernel", "path": "specs/product/level-0/kernel.json", "status": "accepted", "level": 0},
                {"spec_id": "product.primitive", "path": "specs/product/level-1/primitive.json", "status": "accepted", "level": 1},
                {"spec_id": "product.component", "path": "specs/product/level-2/component.json", "status": "accepted", "level": 2},
                {"spec_id": "product.orchestration", "path": "specs/product/level-3/orchestration.json", "status": "accepted", "level": 3},
                {"spec_id": "product.a", "path": "specs/product/level-0/a.json", "status": "accepted", "level": 0},
        ...
        install_fixture(temp_repo, "level-1-accepted.json", "specs/product/level-1/primitive.json")
        install_fixture(temp_repo, "level-1-accepted.json", "specs/product/level-1/a.json")
        install_fixture(temp_repo, "level-1-accepted.json", "specs/product/level-1/b.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/component.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/orchestration.json")
        configure_spec(temp_repo, "specs/product/level-1/a.json", spec_id="product.a", title="A", purpose="A product specification.", dependency_ids=["product.b"])
        ...
        write_manifest(
            ...
            [
                ...
                {"spec_id": "product.component", "path": "specs/product/level-2/component.json", "status": "accepted", "level": 2},
                {"spec_id": "product.orchestration", "path": "specs/product/level-3/orchestration.json", "status": "accepted", "level": 3},
                {"spec_id": "product.a", "path": "specs/product/level-1/a.json", "status": "accepted", "level": 1},
        ...
        install_fixture(temp_repo, "level-0-candidate.json", "specs/product/level-0/kernel.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/component.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/a.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/b.json")
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/c.json")
        install_fixture(temp_repo, "level-1-accepted.json", "specs/product/level-1/primitive.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/orchestration.json")
        configure_spec(temp_repo, "specs/product/level-2/a.json", spec_id="product.a", title="A", purpose="A product specification.", dependency_ids=["product.b"])
        configure_spec(temp_repo, "specs/product/level-2/b.json", spec_id="product.b", title="B", purpose="B product specification.", dependency_ids=["product.c"])
        ...
        write_manifest(
            ...
            [
                ...
                {"spec_id": "product.component", "path": "specs/product/level-2/component.json", "status": "accepted", "level": 2},
                {"spec_id": "product.orchestration", "path": "specs/product/level-3/orchestration.json", "status": "accepted", "level": 3},
                {"spec_id": "product.a", "path": "specs/product/level-2/a.json", "status": "accepted", "level": 2},
                {"spec_id": "product.b", "path": "specs/product/level-2/b.json", "status": "accepted", "level": 2},
        ...
        install_fixture(temp_repo, "level-2-accepted.json", "specs/product/level-2/component.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/orchestration.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/a.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/b.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/c.json")
        install_fixture(temp_repo, "level-3-accepted.json", "specs/product/level-3/d.json")
        configure_spec(temp_repo, "specs/product/level-3/a.json", spec_id="product.a", title="A", purpose="A product specification.", dependency_ids=["product.b"])
        configure_spec(temp_repo, "specs/product/level-3/b.json", spec_id="product.b", title="B", purpose="B product specification.", dependency_ids=["product.c"])
        configure_spec(temp_repo, "specs/product/level-3/c.json", spec_id="product.c", title="C", purpose="C product specification.", dependency_ids=["product.d"])
        ...
        write_manifest(
            ...
            [
                ...
                {"spec_id": "product.component", "path": "specs/product/level-2/component.json", "status": "accepted", "level": 2},
                {"spec_id": "product.orchestration", "path": "specs/product/level-3/orchestration.json", "status": "accepted", "level": 3},
                {"spec_id": "product.a", "path": "specs/product/level-3/a.json", "status": "accepted", "level": 3},
                {"spec_id": "product.b", "path": "specs/product/level-3/b.json", "status": "accepted", "level": 3},
                {"spec_id": "product.c", "path": "specs/product/level-3/c.json", "status": "accepted", "level": 3},
