    ...
    for spec_id, spec in context.product.specs.items():
        ...
        for index, record in enumerate(conformance):
            ...
            for mapping_id in implementation_ids:
                ...
                referenced_implementation_ids.add(mapping_id)
            ...
            for mapping_id in test_ids:
                ...
                referenced_test_ids.add(mapping_id)

        unused_implementation_ids = sorted(set(implementation_index) - referenced_implementation_ids)
        ...
        unused_test_ids = sorted(set(test_index) - referenced_test_ids)
