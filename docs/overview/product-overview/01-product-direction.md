...
repo-spec is a top-down engineering framework for AI-assisted software development. It progressively reduces complex conversational human intent into smaller, increasingly authoritative units until each remaining task is sufficiently bounded for reliable AI implementation.
